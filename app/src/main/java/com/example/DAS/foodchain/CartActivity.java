...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //String url="http://ec2-52-56-170-196.eu-west-2.compute.amazonaws.com/jbarbero004/WEB/foodorder/customer/showcart.php?email="+email;
        ...
        protected void onPostExecute(String result) {
            ...
            placeorder.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //String url="http://ec2-52-56-170-196.eu-west-2.compute.amazonaws.com/jbarbero004/WEB/foodorder/customer/currentorders.php";
